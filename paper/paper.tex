...
\begin{chapter}{Methodology}
    ...
    \begin{section}{Singular Value Decomposition and Random Dot Product Graphs}
        ...
        Aligning The L and R matrices is important (The SVDs can each be fliped)
        We use an initial vector to ensure that the first eigenvector is oriented the same for each time step
        Then calculate a transformation for the subsequent eigenvectors, which is used for training loss and prediction.
